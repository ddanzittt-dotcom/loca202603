          ...
          <div className="shared-viewer__selected">
            <div className="shared-viewer__selected-head">
              <div className="shared-viewer__selected-info">
                <strong>{(() => { const catId = selectedFeature.category || emojiToCategory(selectedFeature.emoji); const ic = getPinIcon(catId); return <><span className="sv-cat-icon" style={{background:ic.bg}}><img src={`/icons/pins/${catId}.svg`} width="12" height="12" alt="" /></span>{selectedFeature.title}</> })()} </strong>
              </div>
        ...
        <div className="sv-event__spot-card">
          <div className="sv-event__spot-head">
            <div className="sv-event__spot-info">
              <span className="sv-event__spot-emoji">{(() => { const catId = selectedFeature.category || emojiToCategory(selectedFeature.emoji); const ic = getPinIcon(catId); return <span className="sv-cat-icon" style={{ background: ic.bg }}><img src={`/icons/pins/${catId}.svg`} width="16" height="16" alt="" /></span> })()}</span>
              <div>
            ...
            <div className="sv-event__sheet-peek">
              {isCompleted ? (
                ...
                <button className="sv-event__next-spot" type="button" onClick={goToNextSpot}>
                  <span className="sv-event__next-emoji">{(() => { const catId = nextSpot.category || emojiToCategory(nextSpot.emoji); const ic = getPinIcon(catId); return <span className="sv-cat-icon" style={{ background: ic.bg }}><img src={`/icons/pins/${catId}.svg`} width="14" height="14" alt="" /></span> })()}</span>
                  ...
                  <div className="sv-event__spot-list">
                    {features.map((f) => {
                      ...
                      return (
                        ...
                        >
                          <span className="sv-event__spot-row-emoji">{(() => { const catId = f.category || emojiToCategory(f.emoji); const ic = getPinIcon(catId); return <span className="sv-cat-icon" style={{ background: ic.bg }}><img src={`/icons/pins/${catId}.svg`} width="12" height="12" alt="" /></span> })()}</span>
